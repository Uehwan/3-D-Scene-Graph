...
__C.IS_RPN = True
__C.PHRASE_REGION_OVERLAP_THRESH = 0.8
...
__C.TRAIN.BATCH_SIZE_REGION = 128
__C.TRAIN.BATCH_SIZE_IMG = 5

# The maximum iteration numbers for random MPS iterations
__C.TRAIN.MAX_MPS_ITER_NUM = 5
...
__C.TRAIN.BG_THRESH_HI_REGION = 0.5
...
__C.TRAIN.RPN_CLOBBER_POSITIVES_REGION = True
...
# regression loss weight for RPN
# __C.TRAIN.RPN_REGRESSION_LOSS_WEIGHT = 1.

__C.TRAIN.RPN_ALLOWED_BORDER = 128

# The maximum length for region description
__C.TRAIN.LANGUAGE_MAX_LENGTH = 40
...
__C.TEST.RPN_POST_NMS_TOP_N_REGION = 300
# __C.TEST.RPN_POST_NMS_TOP_N = 2000
# Proposal height and width both need to be greater than RPN_MIN_SIZE (at orig image scale)
__C.TEST.RPN_MIN_SIZE = 16
__C.TEST.RPN_MIN_SIZE_REGION = 32

__C.TEST.RPN_DROPOUT_BOXES_RUNOFF_IMAGE = False

__C.TEST.BBOX_NUM = 64
__C.TEST.REGION_NUM = 64

# The maximum iteration numbers for random MPS iterations
__C.TEST.MPS_ITER_NUM = 2
...
# __C.ANCHOR_SCALES_KMEANS = [23.523, 5.862, 33.797, 34.437, 27.820, 8.628, 8.409, 13.382, 34.316, 3.211, 40.487, 27.293, 30.125, \
#             26.563, 19.277, 23.488, 11.586, 43.349, 19.049, 15.483, 12.611, 18.160, 40.342, 24.848, 18.246, ]

# __C.ANCHOR_RATIOS_KMEANS =  [0.175, 0.988, 0.361, 0.520, 0.335, 1.722, 0.544, 0.942, 1.002, 1.021, 1.446, 2.771, 0.677, 1.505, \
#             0.172, 0.434, 0.346, 0.602, 1.266, 0.227, 2.305, 2.732, 0.730, 0.869, 0.605,]

# __C.ANCHOR_SCALES_NORMAL = [2, 4, 8, 16, 32, 64]

# __C.ANCHOR_RATIOS_NORMAL = [0.25, 0.5, 1, 2, 4]
