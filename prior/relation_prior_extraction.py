...
if __name__=="__main__":
    ...
    try: os.makedirs(osp.join('prior', 'preprocessed'))
    except: pass
    ...
    save_obj(obj_ind2key,filename='prior/preprocessed/object_prior_ind2key')
    save_obj(obj_key2ind,filename='prior/preprocessed/object_prior_key2ind')
    ...
    save_obj(pred_ind2key,filename='prior/preprocessed/pred_prior_ind2key.pkl')
    save_obj(pred_key2ind,filename='prior/preprocessed/pred_prior_key2ind.pkl')
        ...
        for datum in data:
            ...
            for rel in relations:
                ...
                if pred in predicates:
                    ...
                    predicates[pred] = 1
        save_obj(statistics, "prior/preprocessed/relation_prior")




    '''2. processing relation prior'''
    statistics = load_obj("prior/preprocessed/relation_prior")
    ...
    save_obj(statistics, 'prior/preprocessed/relation_prior_prob')
