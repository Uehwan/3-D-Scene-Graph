...
for idx in range(len(imageFileList)):
    ...
    for i, obj_ind in enumerate(obj_inds):
        ...
        print('{obj_ID:5} {obj_cls:15} {obj_score:1.3f} {object_3d_pose_x:15.3f} {object_3d_pose_y:10.3f} {object_3d_pose_z:10.3f}'
              .format(obj_ID=str(i), obj_cls=test_set.object_classes[obj_ind], obj_score=obj_scores[i], object_3d_pose_x=pose_3d_world_coord.item(0), object_3d_pose_y=pose_3d_world_coord.item(1), object_3d_pose_z=pose_3d_world_coord.item(2) ))
    ...
    for i, caption in enumerate(region_caption):
        ...
        if ans[0] != '<end>':
            ...
            print('{idx:5} {sentence}'.format(idx=str(i)+'.',sentence=sentence))
