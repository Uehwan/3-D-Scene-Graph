...
RESULT_PATH = '/media/mil2/HDD/mil2/scannet/ScanNet/SensReader/python/exported/object_detection/'
...
for idx in range(len(imageFileList))[:20]:
    print('.........................................................................')
    print('Image '+str(idx))
    print('.........................................................................')
    ...
    for i, obj_ind in enumerate(obj_inds):
        if args.dataset == 'scannet':
            ...
            pose_3d_list = [pose_3d_world_coord.item(0),pose_3d_world_coord.item(1), pose_3d_world_coord.item(2)]
            pose_3d_lists.append(pose_3d_list)
            image_idx =idx
            t.append(image_idx)
            #pprint.pprint(box_center_color)
...
def update_graph(num):
    data = df[df['image']==num]
    graph._offsets3d = (data.x, data.y, data.z)

if args.dataset == 'scannet':
    pose_3d_lists = np.array(pose_3d_lists)
    t = np.array(t)
    df = pd.DataFrame({"image": t, "x": pose_3d_lists[:,0], "y": pose_3d_lists[:,1], "z": pose_3d_lists[:,2], "color": color})
    data = df[df['image']==0]
    graph = ax.scatter(data.x, data.y, data.z, c = data.color,  marker = '.')
    ani = animation.FuncAnimation(fig, update_graph, image_idx, interval=40, blit=False)
    plt.show()
