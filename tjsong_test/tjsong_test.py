...
for idx in range(len(imageFileList))[0:]:
    ...
    #print(data.node_feature[0]) # image number select
    #print(data.node_feature[0][0]) # show one pack of object node info
    #print(data.node_feature[0][0][0]) # select node's info [0~6] (name, obj_idx, ...) 
    print('.........................................................................')
    print(data.relation)
    #print(data.relation[0])
